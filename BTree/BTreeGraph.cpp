#include "BTreeGraph.hpp"

BTreeGraph::BTreeGraph(sf::RenderWindow &window) : window(window),
...
bool BTreeGraph::eventTest()
{
    ...
    while (window.pollEvent(event))
    {
        ...
        if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
        {
            ...
            {
                timer.startTimer();
                BTreeNode *found = tree.getNode(std::stoll(searchInput.getValue()));
                timer.endTimer();
                timerOutput();
                page[0] = found;
                page[1] = nullptr;
        ...
        if (event.type == sf::Event::KeyPressed)
        {
            if (event.key.code == sf::Keyboard::Left || event.key.code == sf::Keyboard::Q)
                page = tree.getPageElements(1, page[0]);

            if (event.key.code == sf::Keyboard::W)
                page = tree.getPageElements(2, page[0]);

            if (event.key.code == sf::Keyboard::E)
                page = tree.getPageElements(3, page[0]);

            if (event.key.code == sf::Keyboard::Right || event.key.code == sf::Keyboard::R)
                page = tree.getPageElements(4, page[0]);

            if (event.key.code == sf::Keyboard::Up)
                page = tree.getPageElements(0, page[0]);
        }
...
void BTreeGraph::timerOutput()
{
    timeOutputText.setString("  " + std::to_string(timer.getTime()) + "uS");
}

void BTreeGraph::updatePages()
{
    pageNumber = 0;
    page = tree.getPageElements(0, nullptr);
}

void BTreeGraph::treeOutput()
{

    treeNode1.setFillColor(sf::Color::White);
    treeNode2.setFillColor(sf::Color::White);
    treeNode3.setFillColor(sf::Color::White);
    treeNode4.setFillColor(sf::Color::White);
    treeNode5.setFillColor(sf::Color::White);
    ...
    arrow44.setFillColor(sf::Color::White);

    treeNode1.setSize(sf::Vector2f(450.f, 250.f));
    treeNode1.setFillColor(sf::Color::Black);
    treeNode1.setPosition(620.f, 450.f);

    treeNodeText1.setFont(font);
    treeNodeText1.setCharacterSize(20);
    treeNodeText1.setFillColor(sf::Color::White);
    treeNodeText1.setPosition(630.f, 450.f);

    if (page[0] != nullptr)
    {
        std::vector<Data *> vec = page[0]->getData();
        std::string out;
        ...
        for (int i = 0; i < vec.size(); i++)
        {
            if (vec[i] != nullptr)
            {
                out += "\n\nT" + std::to_string(i + 1) + ": " + std::to_string(vec[i]->getTime());
            }
        }

        treeNodeText1.setString(out);
    }
    else
    {
    ...
    arrow1.setSize(sf::Vector2f(350.f, 30.f));
    arrow1.setFillColor(sf::Color::Black);
    arrow1.setPosition(270.f, 550.f);

    arrow11.setSize(sf::Vector2f(30.f, 170.f));
    arrow11.setFillColor(sf::Color::Black);
    arrow11.setPosition(270.f, 550.f);

    treeNode2.setSize(sf::Vector2f(300.f, 250.f));
    treeNode2.setFillColor(sf::Color::Black);
    treeNode2.setPosition(150.f, 720.f);

    treeNodeText2.setFont(font);
    treeNodeText2.setCharacterSize(20);
    treeNodeText2.setFillColor(sf::Color::White);
    treeNodeText2.setPosition(160.f, 730.f);

    if (page[1] != nullptr)
    {
        std::vector<Data *> vec = page[1]->getData();
        std::string out;
    ...
    arrow2.setPosition(620.f, 700.f);

    treeNode3.setSize(sf::Vector2f(300.f, 250.f));
    treeNode3.setFillColor(sf::Color::Black);
    treeNode3.setPosition(510.f, 720.f);

    treeNodeText3.setFont(font);
    treeNodeText3.setCharacterSize(20);
    treeNodeText3.setFillColor(sf::Color::White);
    treeNodeText3.setPosition(520.f, 730.f);

    if (page[2] != nullptr)
    {
        std::vector<Data *> vec = page[2]->getData();
        std::string out;
    ...
    arrow3.setPosition(1020.f, 700.f);

    treeNode4.setSize(sf::Vector2f(300.f, 250.f));
    treeNode4.setFillColor(sf::Color::Black);
    treeNode4.setPosition(920.f, 720.f);

    treeNodeText4.setFont(font);
    treeNodeText4.setCharacterSize(20);
    treeNodeText4.setFillColor(sf::Color::White);
    treeNodeText4.setPosition(930.f, 730.f);

    if (page[3] != nullptr)
    {
        std::vector<Data *> vec = page[3]->getData();
        std::string out;
        ...
        treeNodeText4.setString(out);
    }
    else
    {
        treeNodeText4.setString("NULLPTR");
    }

    arrow4.setSize(sf::Vector2f(350.f, 30.f));
    arrow4.setFillColor(sf::Color::Black);
    arrow4.setPosition(1070.f, 550.f);

    arrow44.setSize(sf::Vector2f(30.f, 170.f));
    arrow44.setFillColor(sf::Color::Black);
    arrow44.setPosition(1420.f, 550.f);

    treeNode5.setSize(sf::Vector2f(300.f, 250.f));
    treeNode5.setFillColor(sf::Color::Black);
    treeNode5.setPosition(1280.f, 720.f);

    treeNodeText5.setFont(font);
    treeNodeText5.setCharacterSize(20);
    treeNodeText5.setFillColor(sf::Color::White);
    treeNodeText5.setPosition(1290.f, 730.f);

    if (page[4] != nullptr)
    {
        std::vector<Data *> vec = page[4]->getData();
        std::string out;
        ...
        treeNodeText5.setString(out);
    }
    else
    {
        treeNodeText5.setString("NULLPTR");
    }
}

void BTreeGraph::render()
{
    ...
    window.draw(treeNode4);
    window.draw(treeNode5);
    window.draw(treeNodeText1);
    window.draw(treeNodeText2);
    window.draw(treeNodeText3);
    window.draw(treeNodeText4);
    window.draw(treeNodeText5);
    window.draw(arrow1);
    window.draw(arrow2);
    window.draw(arrow3);
    window.draw(arrow4);
